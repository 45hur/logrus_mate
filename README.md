...
**Logrus mate** is a tool for [Logrus](https://github.com/45hur/logrus), it will help you to initial logger by config, including `Formatter`, `Hook`，`Level` and `Output` .
...
| [Syslog](https://github.com/45hur/logrus/blob/master/hooks/syslog/syslog.go) | `network` `address` `priority` `tag`|
| [BugSnag](https://github.com/45hur/logrus/blob/master/hooks/bugsnag/bugsnag.go) | `api-key` |
